...
class Validator
{
    ...
    {
        return $this->recursiveOneLvl();
    }

    public function recursiveOneLvl()
    {
        $out = [];
    ...
    public function resucrsiveError(array $errors, $strKey = '')
    {
        $out = [];
        foreach ($errors as $key => $error) {
            if (is_array($error)) {
                $out += $this->resucrsiveError($error, $strKey . '[' . $key . ']');
    ...
    public function isValid()
    {
        ...
        foreach ($this->rules as $key => $tests) {
            ...
            } elseif ($tests instanceof ValidatorIterator) {
